import{P as p,h as c,E as y,o as w,e as x,f as _,i as L,j as k,$ as F}from"./generated-flow-imports-b2a3a60f.js";import{c as s,r as l,a as g,t as h,d as m,T as u,i as C}from"./indexhtml-8581a1e7.js";const $=s`
  :host {
 ...
 * Copyright (c) 2018 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const W=r=>class extends k(b(r)){static get properties(){return{description:{type:String,value:"Application description",notify:!0},opened:{type:Boolean,value:!1,observer:"_onOpenedChange"},title:{type:String,value:"App name"}}}static get observers(){return["__i18nChanged(i18n)"]}ready(){super.ready(),this._overlayElement=this.$.vaadinLoginOverlayWrapper}connectedCallback(){super.connectedCallback(),this.__restoreOpened&&(this.opened=!0)}disconnectedCallback(){super.disconnectedCallback(),this.__restoreOpened=this.opened,this.opened=!1}__i18nChanged(e){const t=e&&e.header;t&&(this.title=t.title,this.description=t.description)}_preventClosingLogin(e){e.preventDefault()}_retargetEvent(e){e.stopPropagation();const{detail:t,composed:a,cancelable:i,bubbles:o}=e;this.dispatchEvent(new CustomEvent(e.type,{bubbles:o,cancelable:i,composed:a,detail:t}))||e.preventDefault()}async _onOpenedChange(){const e=this.$.vaadinLoginForm;!e.$&&this.updateComplete&&await this.updateComplete,this.opened?(this._undoTitleTeleport=this._teleport("title",this.$.vaadinLoginOverlayWrapper),this._undoFieldsTeleport=this._teleport("custom-form-area",e.$.vaadinLoginFormWrapper,e.querySelector("vaadin-button")),this._undoFooterTeleport=this._teleport("footer",e.$.vaadinLoginFormWrapper),document.body.style.pointerEvents=this.$.vaadinLoginOverlayWrapper._previousDocumentPointerEvents):(e.$.vaadinLoginUsername.value="",e.$.vaadinLoginPassword.value="",this.disabled=!1,this._undoTitleTeleport&&this._undoTitleTeleport(),this._undoFieldsTeleport&&this._undoFieldsTeleport(),this._undoFooterTeleport&&this._undoFooterTeleport())}_teleport(e,t,a){const i=[...this.querySelectorAll(`[slot="${e}"]`)].map(o=>(a?t.insertBefore(o,a):t.appendChild(o),o));return()=>{this.append(...i)}}};/**
 * @license
 * Copyright (c) 2018 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
