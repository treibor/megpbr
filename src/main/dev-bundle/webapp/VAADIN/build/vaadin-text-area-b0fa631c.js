import{c as l,r as s,d as h,T as u}from"./indexhtml-8c9495a3.js";import{i as c,b as m,R as f,I as g,L as x,e as v,h as y,f as _,E as b,P as w}from"./generated-flow-imports-87060759.js";/**
 * @license
 ...
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */s("vaadin-text-area",[v,F],{moduleId:"vaadin-text-area-styles"});class A extends E(u(b(w))){static get is(){return"vaadin-text-area"}static get template(){return y`
    ...
    `}ready(){super.ready(),this._tooltipController=new _(this),this._tooltipController.setPosition("top"),this._tooltipController.setAriaTarget(this.inputElement),this.addController(this._tooltipController)}}h(A);
