 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */class ds extends ls{constructor(e){var t;if(super(e),e.type!==ss.ATTRIBUTE||e.name!=="class"||((t=e.strings)===null||t===void 0?void 0:t.length)>2)throw new Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var r,i;if(this._previousClasses===void 0){this._previousClasses=new Set,e.strings!==void 0&&(this._staticClasses=new Set(e.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in t)t[s]&&!(!((r=this._staticClasses)===null||r===void 0)&&r.has(s))&&this._previousClasses.add(s);return this.render(t)}const n=e.element.classList;this._previousClasses.forEach(s=>{s in t||(n.remove(s),this._previousClasses.delete(s))});for(const s in t){const l=!!t[s];l!==this._previousClasses.has(s)&&!(!((i=this._staticClasses)===null||i===void 0)&&i.has(s))&&(l?(n.add(s),this._previousClasses.add(s)):(n.remove(s),this._previousClasses.delete(s)))}return xe}}const Do=as(ds),mo="css-loading-indicator";var G;(function(o){o.IDLE="",o.FIRST="first",o.SECOND="second",o.THIRD="third"})(G||(G={}));class I extends A{constructor(){super(),this.firstDelay=450,this.secondDelay=1500,this.thirdDelay=5e3,this.expandedDuration=2e3,this.onlineText="Online",this.offlineText="Connection lost",this.reconnectingText="Connection lost, trying to reconnect...",this.offline=!1,this.reconnecting=!1,this.expanded=!1,this.loading=!1,this.loadingBarState=G.IDLE,this.applyDefaultThemeState=!0,this.firstTimeout=0,this.secondTimeout=0,this.thirdTimeout=0,this.expandedTimeout=0,this.lastMessageState=$.CONNECTED,this.connectionStateListener=()=>{this.expanded=this.updateConnectionState(),this.expandedTimeout=this.timeoutFor(this.expandedTimeout,this.expanded,()=>{this.expanded=!1},this.expandedDuration)}}static create(){var e,t;const r=window;return!((e=r.Vaadin)===null||e===void 0)&&e.connectionIndicator||(r.Vaadin=r.Vaadin||{},r.Vaadin.connectionIndicator=document.createElement("vaadin-connection-indicator"),document.body.appendChild(r.Vaadin.connectionIndicator)),(t=r.Vaadin)===null||t===void 0?void 0:t.connectionIndicator}render(){return f`
...
`);async function Os(o){const e=new ce(o),t=document.createElement(o.tagName);t.classList.add(Or),document.body.append(t),o.setupElement&&await o.setupElement(t);const r={themeScope:D.local,localClassName:Or};try{o.elements.forEach(i=>{Mr(t,i,r,!0);let n=Le(i,r);const s=n.match(zr);n=n.replace(zr,"");const l=n.match(Lr),a=n.replace(Lr,"");let d=document.querySelector(a);if(d&&l){const h=`[part~="${l[1]}"]`;d=d.shadowRoot.querySelector(h)}if(!d)return;d.style.transition="none";const c=s?s[1]:null,m=getComputedStyle(d,c);i.properties.forEach(h=>{const g=m.getPropertyValue(h.propertyName)||h.defaultValue||"";e.updatePropertyValue(i.selector,h.propertyName,g)}),Mr(t,i,r,!1)})}finally{try{o.cleanupElement&&await o.cleanupElement(t)}finally{t.remove()}}return e}function Mr(o,e,t,r){if(e.stateAttribute){if(e.stateElementSelector){const i=Le({...e,selector:e.stateElementSelector},t);o=document.querySelector(i)}o&&(r?o.setAttribute(e.stateAttribute,""):o.removeAttribute(e.stateAttribute))}}function Vr(o){return o.trim()}function zs(o){const e=o.element;if(!e)return null;const t=e.querySelector("label");if(t&&t.textContent)return Vr(t.textContent);const r=e.textContent;return r?Vr(r):null}class Ls{constructor(){this._localClassNameMap=new Map}get stylesheet(){return this.ensureStylesheet(),this._stylesheet}add(e){this.ensureStylesheet(),this._stylesheet.replaceSync(e)}clear(){this.ensureStylesheet(),this._stylesheet.replaceSync("")}previewLocalClassName(e,t){if(!e)return;const r=this._localClassNameMap.get(e);r&&(e.classList.remove(r),e.overlayClass=null),t?(e.classList.add(t),e.overlayClass=t,this._localClassNameMap.set(e,t)):this._localClassNameMap.delete(e)}ensureStylesheet(){this._stylesheet||(this._stylesheet=new CSSStyleSheet,this._stylesheet.replaceSync(""),document.adoptedStyleSheets=[...document.adoptedStyleSheets,this._stylesheet])}}const fe=new Ls;class Ms{constructor(e){this.pendingRequests={},this.requestCounter=0,this.globalUiId=this.getGlobalUiId(),this.wrappedConnection=e;const t=this.wrappedConnection.onMessage;this.wrappedConnection.onMessage=r=>{r.command==="themeEditorResponse"?this.handleResponse(r.data):t.call(this.wrappedConnection,r)}}sendRequest(e,t){const r=(this.requestCounter++).toString(),i=t.uiId??this.globalUiId;return new Promise((n,s)=>{this.wrappedConnection.send(e,{...t,requestId:r,uiId:i}),this.pendingRequests[r]={resolve:n,reject:s}})}handleResponse(e){const t=this.pendingRequests[e.requestId];if(!t){console.warn("Received response for unknown request");return}delete this.pendingRequests[e.requestId],e.code==="ok"?t.resolve(e):t.reject(e)}loadComponentMetadata(e){return this.sendRequest("themeEditorComponentMetadata",{nodeId:e.nodeId})}setLocalClassName(e,t){return this.sendRequest("themeEditorLocalClassName",{nodeId:e.nodeId,className:t})}setCssRules(e){return this.sendRequest("themeEditorRules",{rules:e})}loadRules(e){return this.sendRequest("themeEditorLoadRules",{selectors:e})}markAsUsed(){return this.sendRequest("themeEditorMarkAsUsed",{})}undo(e){return this.sendRequest("themeEditorHistory",{undo:e})}redo(e){return this.sendRequest("themeEditorHistory",{redo:e})}openCss(e){return this.sendRequest("themeEditorOpenCss",{selector:e})}getGlobalUiId(){const e=window.Vaadin;if(e&&e.Flow){const{clients:t}=e.Flow,r=Object.keys(t);for(const i of r){const n=t[i];if(n.getNodeId)return n.getUIId()}}return-1}}const O={index:-1,entries:[]};class Vs{constructor(e){this.api=e}get allowUndo(){return O.index>=0}get allowRedo(){return O.index<O.entries.length-1}get allowedActions(){return{allowUndo:this.allowUndo,allowRedo:this.allowRedo}}push(e,t,r){const i={requestId:e,execute:t,rollback:r};if(O.index++,O.entries=O.entries.slice(0,O.index),O.entries.push(i),t)try{t()}catch(n){console.error("Execute history entry failed",n)}return this.allowedActions}async undo(){if(!this.allowUndo)return this.allowedActions;const e=O.entries[O.index];O.index--;try{await this.api.undo(e.requestId),e.rollback&&e.rollback()}catch(t){console.error("Undo failed",t)}return this.allowedActions}async redo(){if(!this.allowRedo)return this.allowedActions;O.index++;const e=O.entries[O.index];try{await this.api.redo(e.requestId),e.execute&&e.execute()}catch(t){console.error("Redo failed",t)}return this.allowedActions}static clear(){O.entries=[],O.index=-1}}var Ds=Object.defineProperty,Us=Object.getOwnPropertyDescriptor,ue=(o,e,t,r)=>{for(var i=r>1?void 0:r?Us(e,t):e,n=o.length-1,s;n>=0;n--)(s=o[n])&&(i=(r?s(e,t,i):s(i))||i);return r&&i&&Ds(e,t,i),i};class js extends CustomEvent{constructor(e,t,r){super("theme-property-value-change",{bubbles:!0,composed:!0,detail:{element:e,property:t,value:r}})}}class W extends A{constructor(){super(...arguments),this.value=""}static get styles(){return[_i,b`
    ...
    `}updateValueFromTheme(){var e;this.propertyValue=this.theme.getPropertyValue(this.elementMetadata.selector,this.propertyMetadata.propertyName),this.value=((e=this.propertyValue)==null?void 0:e.value)||""}dispatchChange(e){this.dispatchEvent(new js(this.elementMetadata,this.propertyMetadata,e))}}ue([y({})],W.prototype,"elementMetadata",2);ue([y({})],W.prototype,"propertyMetadata",2);ue([y({})],W.prototype,"theme",2);ue([T()],W.prototype,"propertyValue",2);ue([T()],W.prototype,"value",2);class Nt{constructor(e){if(this._values=[],this._rawValues={},e){const t=e.propertyName,r=e.presets??[];this._values=(r||[]).map(n=>n.startsWith("--")?`var(${n})`:n);const i=document.createElement("div");i.style.borderStyle="solid",i.style.visibility="hidden",document.body.append(i);try{this._values.forEach(n=>{i.style.setProperty(t,n);const s=getComputedStyle(i);this._rawValues[n]=s.getPropertyValue(t).trim()})}finally{i.remove()}}}get values(){return this._values}get rawValues(){return this._rawValues}tryMapToRawValue(e){return this._rawValues[e]??e}tryMapToPreset(e){return this.findPreset(e)??e}findPreset(e){const t=e&&e.trim();return this.values.find(r=>this._rawValues[r]===t)}}class Dr extends CustomEvent{constructor(e){super("change",{detail:{value:e}})}}let Pt=class extends A{constructor(){super(...arguments),this.value="",this.showClearButton=!1}static get styles(){return b`
      :host {
        display: inline-block;
        width: 100%;
        position: relative;
    ...
    `}handleInputChange(o){const e=o.target;this.dispatchEvent(new Dr(e.value))}handleClearClick(){this.dispatchEvent(new Dr(""))}};ue([y({})],Pt.prototype,"value",2);ue([y({})],Pt.prototype,"showClearButton",2);Pt=ue([F("vaadin-dev-tools-theme-text-input")],Pt);var Fs=Object.defineProperty,Bs=Object.getOwnPropertyDescriptor,Dt=(o,e,t,r)=>{for(var i=r>1?void 0:r?Bs(e,t):e,n=o.length-1,s;n>=0;n--)(s=o[n])&&(i=(r?s(e,t,i):s(i))||i);return r&&i&&Fs(e,t,i),i};class Hs extends CustomEvent{constructor(e){super("class-name-change",{detail:{value:e}})}}let Qe=class extends A{constructor(){super(...arguments),this.editedClassName="",this.invalid=!1}static get styles(){return[_i,b`
        .editor-row {
          padding-top: 0;
        }
    ...
    </div>`}handleInputChange(o){this.editedClassName=o.detail.value;const e=/^-?[_a-zA-Z]+[_a-zA-Z0-9-]*$/;this.invalid=!this.editedClassName.match(e),!this.invalid&&this.editedClassName!==this.className&&this.dispatchEvent(new Hs(this.editedClassName))}};Dt([y({})],Qe.prototype,"className",2);Dt([T()],Qe.prototype,"editedClassName",2);Dt([T()],Qe.prototype,"invalid",2);Qe=Dt([F("vaadin-dev-tools-theme-class-name-editor")],Qe);var Ws=Object.defineProperty,qs=Object.getOwnPropertyDescriptor,Ut=(o,e,t,r)=>{for(var i=r>1?void 0:r?qs(e,t):e,n=o.length-1,s;n>=0;n--)(s=o[n])&&(i=(r?s(e,t,i):s(i))||i);return r&&i&&Ws(e,t,i),i};class Gs extends CustomEvent{constructor(e){super("scope-change",{detail:{value:e}})}}Uo(b`
...
`);let Ze=class extends A{constructor(){super(...arguments),this.value=D.local}static get styles(){return b`
      vaadin-select {
        --lumo-primary-color-50pct: rgba(255, 255, 255, 0.5);
        width: 100px;
      }
    ...
    ></vaadin-select>`}selectRenderer(o){var e;const t=((e=this.metadata)==null?void 0:e.displayName)||"Component",r=`${t}s`;Ie(f`
      ...
      `,o)}handleValueChange(o){const e=o.detail.value;e!==this.value&&this.dispatchEvent(new Gs(e))}};Ut([y({})],Ze.prototype,"value",2);Ut([y({})],Ze.prototype,"metadata",2);Ut([rt("vaadin-select")],Ze.prototype,"select",2);Ze=Ut([F("vaadin-dev-tools-theme-scope-selector")],Ze);var Ks=Object.defineProperty,Ys=Object.getOwnPropertyDescriptor,Js=(o,e,t,r)=>{for(var i=r>1?void 0:r?Ys(e,t):e,n=o.length-1,s;n>=0;n--)(s=o[n])&&(i=(r?s(e,t,i):s(i))||i);return r&&i&&Ks(e,t,i),i};let Ur=class extends W{static get styles(){return[W.styles,b`
        .editor-row {
          align-items: center;
        }
      ...
      <vaadin-dev-tools-theme-text-input
        ...
        @change=${this.handleInputChange}
      ></vaadin-dev-tools-theme-text-input>
    `}};jr=Zs([F("vaadin-dev-tools-theme-text-property-editor")],jr);var ea=Object.defineProperty,ta=Object.getOwnPropertyDescriptor,jo=(o,e,t,r)=>{for(var i=r>1?void 0:r?ta(e,t):e,n=o.length-1,s;n>=0;n--)(s=o[n])&&(i=(r?s(e,t,i):s(i))||i);return r&&i&&ea(e,t,i),i};let At=class extends W{constructor(){super(...arguments),this.selectedPresetIndex=-1,this.presets=new Nt}static get styles(){return[W.styles,b`
        :host {
          --preset-count: 3;
          --slider-bg: #fff;
          --slider-border: #333;
      ...
      `]}update(o){o.has("propertyMetadata")&&(this.presets=new Nt(this.propertyMetadata)),super.update(o)}renderEditor(){var o;const e={"slider-wrapper":!0,"custom-value":this.selectedPresetIndex<0},t=this.presets.values.length;return f`
      <div class=${Do(e)}>
        ${null}
        <input
          type="range"
...
`;let et=class extends A{constructor(){super(...arguments),this.commitValue=!1}static get styles(){return[Ci,b`
        #toggle {
          display: block;
        }
    ...
    ></button>`}open(){this.commitValue=!1,this.overlay.opened=!0,this.overlay.style.zIndex="1000000";const o=this.overlay.shadowRoot.querySelector('[part="overlay"]');o.style.background="#333"}renderOverlayContent(o){const e=getComputedStyle(this.toggle,"::after").getPropertyValue("background-color");Ie(f` <div>
      ...
      ></button>`);return f` <div class="swatches">${o}</div>`}handlePickerChange(o){this.dispatchEvent(new CustomEvent("color-changed",{detail:{value:o.detail.value}}))}selectPreset(o){this.dispatchEvent(new CustomEvent("color-changed",{detail:{value:o,close:!0}}))}};_e([y({})],Ot.prototype,"value",2);_e([y({})],Ot.prototype,"presets",2);Ot=_e([F("vaadin-dev-tools-color-picker-overlay-content")],Ot);customElements.whenDefined("vaadin-overlay").then(()=>{const o=customElements.get("vaadin-overlay");class e extends _a(o){}customElements.define("vaadin-dev-tools-color-picker-overlay",e)});customElements.define("vaadin-dev-tools-rgba-string-color-picker",xa);var ka=Object.defineProperty,$a=Object.getOwnPropertyDescriptor,Ta=(o,e,t,r)=>{for(var i=r>1?void 0:r?$a(e,t):e,n=o.length-1,s;n>=0;n--)(s=o[n])&&(i=(r?s(e,t,i):s(i))||i);return r&&i&&ka(e,t,i),i};let Gr=class extends W{constructor(){super(...arguments),this.presets=new Nt}static get styles(){return[W.styles,b`
        .editor-row {
          align-items: center;
        }
      ...
      `]}update(o){o.has("propertyMetadata")&&(this.presets=new Nt(this.propertyMetadata)),super.update(o)}renderEditor(){var o;return f`
    ...
    `}handleOpenCss(o){this.dispatchEvent(new Aa(o))}renderPropertyEditor(o,e){let t;switch(e.editorType){case P.checkbox:t=pt`vaadin-dev-tools-theme-checkbox-property-editor`;break;case P.range:t=pt`vaadin-dev-tools-theme-range-property-editor`;break;case P.color:t=pt`vaadin-dev-tools-theme-color-property-editor`;break;default:t=pt`vaadin-dev-tools-theme-text-property-editor`}return vs` <${t}
        ...
        >
        </${t}>`}};Ho([y({})],zt.prototype,"metadata",2);Ho([y({})],zt.prototype,"theme",2);zt=Ho([F("vaadin-dev-tools-theme-property-list")],zt);var Ia=Object.defineProperty,Ra=Object.getOwnPropertyDescriptor,Oa=(o,e,t,r)=>{for(var i=r>1?void 0:r?Ra(e,t):e,n=o.length-1,s;n>=0;n--)(s=o[n])&&(i=(r?s(e,t,i):s(i))||i);return r&&i&&Ia(e,t,i),i};let Lt=class extends A{render(){return f`<div
      tabindex="-1"
    ...
    `];Lt=Oa([F("vaadin-dev-tools-shim")],Lt);const ki=b`
  .popup {
    width: auto;
    position: fixed;
 ...
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Ai=[];function Ii(o){return o&&Object.prototype.hasOwnProperty.call(o,"__themes")}function sl(o){return Ii(customElements.get(o))}function al(o=[]){return[o].flat(1/0).filter(e=>e instanceof Oo?!0:(console.warn("An item in styles is not of type CSSResult. Use `unsafeCSS` or `css`."),!1))}function nt(o,e,t={}){o&&sl(o)&&console.warn(`The custom element definition for "${o}"
      was finalized before a style module was registered.
      Make sure to add component specific style modules before
      importing the corresponding custom element.`),e=al(e),window.Vaadin&&window.Vaadin.styleModules?window.Vaadin.styleModules.registerStyles(o,e,t):Ai.push({themeFor:o,styles:e,include:t.include,moduleId:t.moduleId})}function Po(){return window.Vaadin&&window.Vaadin.styleModules?window.Vaadin.styleModules.getAllThemes():Ai}function ll(o,e){return(o||"").split(" ").some(t=>new RegExp(`^${t.split("*").join(".*")}$`,"u").test(e))}function dl(o=""){let e=0;return o.startsWith("lumo-")||o.startsWith("material-")?e=1:o.startsWith("vaadin-")&&(e=2),e}function Ri(o){const e=[];return o.include&&[].concat(o.include).forEach(t=>{const r=Po().find(i=>i.moduleId===t);r?e.push(...Ri(r),...r.styles):console.warn(`Included moduleId ${t} not found in style registry`)},o.styles),e}function cl(o,e){const t=document.createElement("style");t.innerHTML=o.map(r=>r.cssText).join(`
`),e.content.appendChild(t)}function hl(o){const e=`${o}-default-theme`,t=Po().filter(r=>r.moduleId!==e&&ll(r.themeFor,o)).map(r=>({...r,styles:[...Ri(r),...r.styles],includePriority:dl(r.moduleId)})).sort((r,i)=>i.includePriority-r.includePriority);return t.length>0?t:Po().filter(r=>r.moduleId===e)}const Il=o=>class extends nl(o){static finalize(){if(super.finalize(),this.elementStyles)return;const t=this.prototype._template;!t||Ii(this)||cl(this.getStylesForThis(),t)}static finalizeStyles(t){const r=this.getStylesForThis();return t?[...super.finalizeStyles(t),...r]:r}static getStylesForThis(){const t=Object.getPrototypeOf(this.prototype),r=(t?t.constructor.__themes:[])||[];this.__themes=[...r,...hl(this.is)];const i=this.__themes.flatMap(n=>n.styles);return i.filter((n,s)=>s===i.lastIndexOf(n))}};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const ul=(o,...e)=>{const t=document.createElement("style");t.id=o,t.textContent=e.map(r=>r.toString()).join(`
`).replace(":host","html"),document.head.insertAdjacentElement("afterbegin",t)},pl=b`.high-rating{background-color:var(--lumo-success-color-5pct)}.low-rating{background-color:var(--lumo-error-color-10pct)}.font-weight-bold{font-weight:700}
`;document._vaadintheme_megpbr_componentCss||(nt("vaadin-grid",zo(pl.toString())),document._vaadintheme_megpbr_componentCss=!0);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class ml extends HTMLElement{static get version(){return"24.1.9"}}customElements.define("vaadin-lumo-styles",ml);const me=(o,...e)=>{ul(`lumo-${o}`,e)};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const gl=b`
...
`;nt("",Go,{moduleId:"lumo-typography"});me("typography-props",gl);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const fl=b`
  ${zo(Go.cssText.replace(/,\s*:host/su,""))}
`;me("typography",fl,!1);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
${kl}
${$l}
`;nt("",Jo,{moduleId:"lumo-utility"});/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */me("utility",Jo);const Tl=o=>{const e=[];o!==document&&(e.push(Fe(Go.cssText,"",o,!0)),e.push(Fe(Ko.cssText,"",o,!0)),e.push(Fe(Oi.cssText,"",o,!0)),e.push(Fe(Yo.cssText,"",o,!0)),e.push(Fe(Jo.cssText,"",o,!0)))},Nl=Tl;Nl(document);export{ls as D,Be as F,A as L,ss as P,Il as T,Pe as U,E as _,me as a,xe as b,b as c,as as d,nt as e,Ko as f,Go as g,f as h,nl as i,J as j,Cs as k,ks as l,k as n,Ie as r,Ne as s,Ai as t,zo as u,P as y};
