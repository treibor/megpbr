...
public class Markets {
	//For format 7-10
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "marketid_generator")
	@SequenceGenerator(name="marketid_generator", sequenceName = "marketid_seq", allocationSize=1)
	private long id;
