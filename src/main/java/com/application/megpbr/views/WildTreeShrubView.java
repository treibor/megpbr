...
@PageTitle("Trees||Shrubs||Herbs..")
@Route(value = "treeshrubsherbs", layout = MainLayout.class)
@Uses(Icon.class)
public class WildTreeShrubView extends VerticalLayout{
	...
	public WildTreeShrubView(Dbservice service, CropService cservice) {
