...
@PageTitle("Markets||Fairs")
@Route(value = "marketsfairs", layout = MainLayout.class)
@Uses(Icon.class)
public class MarketsFairView extends VerticalLayout{
	...
	public MarketsFairView(Dbservice service, MarketsService cservice) {
		this.dbservice=service;
		this.cservice=cservice;
		format=dbservice.getFormat(17);
		setSizeFull();
		ConfigureGrid();
		ConfigureForm();
		ConfigureCombo();
	...
	public Component ConfigureGrid() {
		try {
			grid.setSizeFull();
			grid.setColumns("id");
			localColumn = grid.addColumn("name").setHeader("Weekly Market Name").setAutoWidth(true).setResizable(true);
			grid.addColumn("frequency").setHeader("Frequency").setAutoWidth(true).setResizable(true);
			grid.addColumn("month").setHeader("Day/Month(In Case of Bi Annual/Annual)").setAutoWidth(true).setResizable(true);
			...
			grid.addColumn("placesFrom").setHeader("Places From Which Animals Arrive").setAutoWidth(true).setResizable(true);
			grid.addColumn("placesTo").setHeader("Places To Which Animals Are Transported").setAutoWidth(true).setResizable(true);
