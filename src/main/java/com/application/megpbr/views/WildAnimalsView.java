...
@Route(value = "wildanimals", layout = MainLayout.class)
@Uses(Icon.class)
public class WildAnimalsView extends VerticalLayout{
	...
	public WildAnimalsView(Dbservice service, CropService cservice) {
	...
	public Component ConfigureGrid() {
		try {
			...
			grid.addColumn("xfield1").setHeader("Mode of Hunting");
