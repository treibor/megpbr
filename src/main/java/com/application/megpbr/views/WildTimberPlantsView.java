...
@PageTitle("Wild Timber Plants")
@Route(value = "wildtimberplants", layout = MainLayout.class)
@Uses(Icon.class)
public class WildTimberPlantsView extends VerticalLayout{
	...
	public WildTimberPlantsView(Dbservice service, CropService cservice) {
	...
	public Component ConfigureGrid() {
		try {
			...
			grid.addColumn("uses").setHeader("Other Uses").setAutoWidth(true).setResizable(true).setSortable(true);
