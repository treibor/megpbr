...
@Route(value = "timberplants", layout = MainLayout.class)
@Uses(Icon.class)
public class TimberPlantsView extends VerticalLayout{
	...
	public TimberPlantsView(Dbservice service, CropService cservice) {
	...
	public Component ConfigureGrid() {
		try {
			...
			grid.addColumn("wildhome").setHeader("Wild/Home");
