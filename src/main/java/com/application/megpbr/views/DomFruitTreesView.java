...
public class DomFruitTreesView extends VerticalLayout{
	...
	public DomFruitTreesView(Dbservice service, CropService cservice) {
		this.dbservice=service;
		this.cservice=cservice;
		format=dbservice.getFormat(11);
		setSizeFull();
		ConfigureGrid();
		ConfigureForm();
		ConfigureCombo();
	...
	public Component ConfigureGrid() {
		try {
			...
			grid.addColumn("scientificName").setHeader("Scientific Name").setAutoWidth(true).setResizable(true).setSortable(true);;
			...
			grid.addColumn("fruitSeason").setHeader("Fruit Season").setAutoWidth(true).setResizable(true).setSortable(true);
