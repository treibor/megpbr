...
@Route(value = "ornamentalplants", layout = MainLayout.class)
@Uses(Icon.class)
public class OrnamentalPlantsView extends VerticalLayout{
	...
	public OrnamentalPlantsView(Dbservice service, CropService cservice) {
