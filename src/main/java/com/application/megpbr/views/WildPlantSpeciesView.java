...
@PageTitle("Wild Plant Species")
@Route(value = "wildplantspecies", layout = MainLayout.class)
@Uses(Icon.class)
public class WildPlantSpeciesView extends VerticalLayout{
	...
	public WildPlantSpeciesView(Dbservice service, CropService cservice) {
	...
	public Component ConfigureGrid() {
		try {
			...
			//grid.addColumn("partsUsed").setHeader("Parts Collected");
			...
			grid.addColumn("xfield2").setHeader("Status");
			//grid.addColumn("commercial").setHeader("Commercial/Own Use");
