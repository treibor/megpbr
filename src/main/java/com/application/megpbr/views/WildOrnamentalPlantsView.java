...
@Route(value = "wildornamentalplants", layout = MainLayout.class)
@Uses(Icon.class)
public class WildOrnamentalPlantsView extends VerticalLayout{
	...
	public WildOrnamentalPlantsView(Dbservice service, CropService cservice) {
	...
	public Component ConfigureGrid() {
		try {
			...
			grid.addColumn("commercial").setHeader("Commercial/Non Commercial");
