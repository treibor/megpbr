...
@PageTitle("Soil Type")
@Route(value = "soiltype", layout = MainLayout.class)
@Uses(Icon.class)
public class SoilTypeView extends VerticalLayout {
	...
	public SoilTypeView(Dbservice service, ScapeService cservice) {
		this.dbservice = service;
		this.sservice = cservice;
		format = dbservice.getFormat(10);
		setSizeFull();
		ConfigureGrid();
		ConfigureForm();
		ConfigureCombo();
	...
	public Component ConfigureGrid() {
		try {
			grid.setSizeFull();
			grid.setColumns("id");
			 grid.addColumn(Scapes::getFaunaPopulation).setHeader("Soil Type").setAutoWidth(true).setResizable(true).setSortable(true);
			floraColumn = grid.addColumn("floraOccupation").setHeader("Colour & Texture").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("typeAgriOccupation").setAutoWidth(true).setHeader("Features").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("landscape").setAutoWidth(true).setHeader("Soil Management").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("fallow").setHeader("Flora & Fauna").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("forest").setHeader("Plant/Crop Suitable").setAutoWidth(true).setResizable(true).setSortable(true);
			//grid.addColumn("wetLand").setHeader("Wet Land").setAutoWidth(true).setResizable(true).setSortable(true);
