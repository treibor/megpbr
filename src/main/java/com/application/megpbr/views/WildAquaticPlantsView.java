...
@Route(value = "wildaquaticplants", layout = MainLayout.class)
@Uses(Icon.class)
public class WildAquaticPlantsView extends VerticalLayout{
	...
	public WildAquaticPlantsView(Dbservice service, CropService cservice) {
	...
	public Component ConfigureGrid() {
		try {
			...
			grid.addColumn("xfield1").setHeader("Importance");
