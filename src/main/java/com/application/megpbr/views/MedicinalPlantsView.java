...
@Route(value = "medicinalplants", layout = MainLayout.class)
@Uses(Icon.class)
public class MedicinalPlantsView extends VerticalLayout{
	...
	public MedicinalPlantsView(Dbservice service, CropService cservice) {
