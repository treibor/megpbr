...
@PageTitle("Weeds")
@Route(value = "weeds", layout = MainLayout.class)
@Uses(Icon.class)
public class WeedsView extends VerticalLayout{
	...
	public WeedsView(Dbservice service, CropService cservice) {
		this.dbservice=service;
		this.cservice=cservice;
		format=dbservice.getFormat(4);
		setSizeFull();
		ConfigureGrid();
		ConfigureForm();
		ConfigureCombo();
	...
	public Component ConfigureGrid() {
		try {
			...
			grid.addColumn("management").setHeader("Management Options");
			grid.addColumn("xfield1").setHeader("Affected Crops");
			grid.addColumn("xfield2").setHeader("Impact");
