...
@Route(value = "aquaticbiodiversity", layout = MainLayout.class)
@Uses(Icon.class)
public class WildAquaticBiodiversityView extends VerticalLayout{
	...
	public WildAquaticBiodiversityView(Dbservice service, CropService cservice) {
	...
	public Component ConfigureGrid() {
		try {
			...
			grid.addColumn("partsUsed").setHeader("Parts Used");
			...
			//grid.addColumn("xfield1").setHeader("Importance(Economic/Social/Cultural)");
			//grid.addColumn("xfield2").setHeader("Trends");
