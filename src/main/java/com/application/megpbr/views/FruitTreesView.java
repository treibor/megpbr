...
@PageTitle("Fruit Trees - Agro")
@Route(value = "agrofruittrees", layout = MainLayout.class)
@Uses(Icon.class)
public class FruitTreesView extends VerticalLayout{
	...
	private Component getToolbar() {
		...
		String formatName;
		if(tempformatName.length()<=20) {
			formatName=tempformatName;
		}else {
			formatName=tempformatName.substring(0, 20);
		}
		var label=new H3("Format-"+format.getFormat()+" - "+formatName);
