...
@Route(value = "culturefisheries", layout = MainLayout.class)
@Uses(Icon.class)
public class CultureFisheriesView extends VerticalLayout{
	...
	public CultureFisheriesView(Dbservice service, CropService cservice) {
	...
	public Component ConfigureGrid() {
		try {
			...
			grid.addColumn("habitat").setHeader("Waterscape").setAutoWidth(true).setResizable(true).setSortable(true);
			...
			grid.addColumn("management").setHeader("Commercial Rearing");
