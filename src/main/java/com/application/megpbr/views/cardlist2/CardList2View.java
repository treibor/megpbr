package com.application.megpbr.views.cardlist2;
...
@PageTitle("Card List2")
@Route(value = "card-list2", layout = MainLayout.class)
public class CardList2View extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public CardList2View() {
        addClassName("card-list2-view");
        setSizeFull();
        grid.setHeight("100%");
