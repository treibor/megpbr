...
@Route(value = "pestscrops", layout = MainLayout.class)
@Uses(Icon.class)
public class PestsCropsView extends VerticalLayout{
	...
	public PestsCropsView(Dbservice service, CropService cservice) {
	...
	public Component ConfigureGrid() {
		try {
			...
			grid.addColumn("management").setHeader("Management Mechanism");
			grid.addColumn("xfield1").setHeader("Hosts");
			grid.addColumn("xfield2").setHeader("Insect/Animal");
