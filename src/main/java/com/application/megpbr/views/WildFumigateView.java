...
@Route(value = "fumigateplants", layout = MainLayout.class)
@Uses(Icon.class)
public class WildFumigateView extends VerticalLayout{
	...
	public WildFumigateView(Dbservice service, CropService cservice) {
