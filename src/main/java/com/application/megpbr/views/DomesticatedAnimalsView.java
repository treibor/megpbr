...
@Route(value = "domesticatedanimals", layout = MainLayout.class)
@Uses(Icon.class)
public class DomesticatedAnimalsView extends VerticalLayout{
	...
	public DomesticatedAnimalsView(Dbservice service, CropService cservice) {
	...
	public Component ConfigureGrid() {
		try {
			...
			grid.addColumn("xfield2").setHeader("Method Of Keeping");
