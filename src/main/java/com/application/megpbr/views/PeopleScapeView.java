...
@PageTitle("Peoplescape")
@Route(value = "peoplescape", layout = MainLayout.class)
@Uses(Icon.class)
public class PeopleScapeView extends VerticalLayout {
	...
	public PeopleScapeView(Dbservice service, ScapeService cservice) {
		this.dbservice = service;
		this.sservice = cservice;
		format = dbservice.getFormat(7);
		setSizeFull();
		ConfigureGrid();
		ConfigureForm();
		ConfigureCombo();
	...
	public Component ConfigureGrid() {
		try {
			grid.setSizeFull();
			grid.setColumns("id");
			 grid.addColumn(Scapes::getFaunaPopulation).setHeader("Community & Population").setResizable(true).setSortable(true);
			floraColumn = grid.addColumn("floraOccupation").setHeader("Families & Major Occupation").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("typeAgriOccupation").setAutoWidth(true).setHeader("Sub Occupation").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("landscape").setAutoWidth(true).setHeader("Depending Landscape").setResizable(true).setSortable(true);
			grid.addColumn("fallow").setHeader("Major Resources & Season of Access").setAutoWidth(true).setResizable(true).setSortable(true);
			//grid.addColumn("forest").setHeader("Forest").setAutoWidth(true);
			//grid.addColumn("wetLand").setHeader("Wet Land").setAutoWidth(true);
			//grid.addColumn("subLandscape").setHeader("Sub Landscape");
			grid.addColumn("ownerHouse").setHeader("Caste/Tribe").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("features").setAutoWidth(true).setHeader("Number of Households").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("userGroups").setAutoWidth(true).setHeader("Nature of Inhabitants").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("management").setHeader("Resource Management Practices").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("generalResources").setHeader("General Uses").setAutoWidth(true).setResizable(true).setSortable(true);
			//grid.addColumn("otherDetails").setAutoWidth(true);
			grid.addColumn("socialCommunity").setHeader("Social Condition").setAutoWidth(true).setResizable(true).setSortable(true);
			//grid.addColumn("localLanguage").setHeader("Uses");
			//grid.addColumn("remarks").setHeader("Uses");
			//grid.addColumn("associatedTk").setHeader("Associated TK").setAutoWidth(true);
			...
			//grid.addColumn(crop -> crop.isApproved() ? "Yes" : "No").setHeader("Verified").setFlexGrow(0).setResizable(true).setSortable(true);
