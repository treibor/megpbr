...
@PageTitle("Landscape")
@Route(value = "landscape", layout = MainLayout.class)
@Uses(Icon.class)
public class ScapeView extends VerticalLayout {
	...
	public ScapeView(Dbservice service, ScapeService cservice) {
		this.dbservice = service;
		this.sservice = cservice;
		format = dbservice.getFormat(8);
		setSizeFull();
		ConfigureGrid();
		ConfigureForm();
		ConfigureCombo();
	...
	public Component ConfigureGrid() {
		try {
			grid.setSizeFull();
			grid.setColumns("id");
			 grid.addColumn(Scapes::getFaunaPopulation).setHeader("General Fauna").setAutoWidth(true).setResizable(true).setSortable(true);
			floraColumn = grid.addColumn("floraOccupation").setHeader("General Flora").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("typeAgriOccupation").setAutoWidth(true).setHeader("Agricultural Land").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("landscape").setAutoWidth(true).setHeader("Pond").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("fallow").setHeader("Fallow Land").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("forest").setHeader("Forest").setAutoWidth(true).setResizable(true).setSortable(true);
