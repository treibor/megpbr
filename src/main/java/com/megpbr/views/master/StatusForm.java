...
public class StatusForm extends Div {
	Dbservice dbservice;
	MasterStatus masterstatus;
	Binder<MasterStatus> binder = new BeanValidationBinder<>(MasterStatus.class);
	TextField status = new TextField("Status Code");
	TextField statusName = new TextField("Status");
	FormLayout form = new FormLayout();
	public Button save = new Button("Add");
	Button delete = new Button("Delete");
	//FormLayout form=new FormLayout();
	public StatusForm(Dbservice dbservice) {
		super();
	...
	private void initForm() {
		binder.setBean(new MasterStatus());
	}
	private Component createButtons() {
		var hl = new HorizontalLayout();
		save.addThemeVariants(ButtonVariant.LUMO_PRIMARY);
		save.addClickShortcut(Key.ENTER);
		save.addClickListener(e -> saveStatus());
		delete.addThemeVariants(ButtonVariant.LUMO_ERROR);
		delete.addClickListener(e -> deletePosition(masterstatus));
	...
	private void saveStatus() {
		try {
			binder.writeBean(masterstatus);
			fireEvent(new SaveEvent(this, masterstatus));
			this.setMasterStatus(new MasterStatus());
	...
	public void deletePosition(MasterStatus masterstatus) {
		if (masterstatus == null) {
			...
			dialog.addConfirmListener(event ->fireEvent(new DeleteEvent(this, masterstatus)));
			dialog.open();
		}
	}
	...
	public static abstract class MasterStatusFormEvent extends ComponentEvent<StatusForm> {
		private MasterStatus masterstatus;

		protected MasterStatusFormEvent(StatusForm source, MasterStatus masterstatus) {
			super(source, false);
			this.masterstatus = masterstatus;
		}
	...
	public static class SaveEvent extends MasterStatusFormEvent {
		SaveEvent(StatusForm source, MasterStatus masterstatus) {
			super(source, masterstatus);
		}
	}

	public static class DeleteEvent extends MasterStatusFormEvent {
		DeleteEvent(StatusForm source, MasterStatus masterstatus) {
			super(source, masterstatus);
		}

	}

	public static class CloseEvent extends MasterStatusFormEvent {
