...
public class CropForm extends Div {
	...
	//boolean isAdmin;
	public CropForm(Dbservice dbservice, CropService cservice) {
		super();
	...
	public Component createAccordion() {
		...
		topaccordion = accordion.add("Basic Info",
				new Div( createMasterForm(), createBasicForm()));
	...
	public Component createBasicForm() {
		...
		ValidationUtil.applyValidation(management);
		...
		ValidationUtil.applyValidation(specialFeatures);
		ValidationUtil.applyValidation(xfield1);
		ValidationUtil.applyValidation(xfield2);
	...
	public static abstract class CropFormEvent extends ComponentEvent<CropForm> {
		private Crops crop;

		protected CropFormEvent(CropForm source, Crops crop) {
			super(source, false);
			this.crop = crop;
		}
	...
	public static class SaveEvent extends CropFormEvent {
		SaveEvent(CropForm source, Crops crop) {
			super(source, crop);
			
		}
	}

	public static class DeleteEvent extends CropFormEvent {
		DeleteEvent(CropForm source, Crops crop) {
			super(source, crop);
		}

	}

	public static class CloseEvent extends CropFormEvent {
		CloseEvent(CropForm source) {
			super(source, null);
		}
	}
	...
	public void initFormatFields(MasterFormat format) {
		...
		localLanguages.setVisible(true);
		localLanguage.setVisible(true);
		fruitSeasons.setVisible(true);
		fruitSeason.setVisible(true);
		pastStatus.setVisible(true);
		presentStatus.setVisible(true);
