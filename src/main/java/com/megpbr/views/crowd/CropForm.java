...
public class CropForm extends Div {
	...
	public Component createBasicForm() {
		...
		TextFieldUtil.applyValidation(management);
		...
		TextFieldUtil.applyValidation(specialFeatures);
		TextFieldUtil.applyValidation(xfield1);
		TextFieldUtil.applyValidation(xfield2);
