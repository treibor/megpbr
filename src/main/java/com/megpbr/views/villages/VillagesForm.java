...
public class VillagesForm extends Div {
	...
	public Component createBasicForm() {
		ValidationUtil.applyValidation(habitat);
		ValidationUtil.applyValidation(rainfall);
		ValidationUtil.applyValidation(temperature);
		ValidationUtil.applyValidation(weatherPatterns);
