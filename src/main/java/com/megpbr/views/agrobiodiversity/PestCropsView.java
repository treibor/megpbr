...
@PageTitle("Pests Crops")
@Route(value = "format-5", layout = MainLayout.class)
@Uses(Icon.class)
public class PestCropsView extends HorizontalLayout{
	...
	public PestCropsView(Dbservice service, CropService cservice, UserService uservice) {
		this.dbservice=service;
		this.cservice=cservice;
		this.uservice=uservice;
		//this.auditservice=auditservice;
		format=dbservice.getFormat(5);
		setSizeFull();
		ConfigureGrid();
		ConfigureForm();
		ConfigureCombo();
	...
	public Component ConfigureGrid() {
		try {
			...
			grid.addColumn("fruitSeason").setHeader("Season of Attack").setAutoWidth(true).setResizable(true).setSortable(true);
			...
			grid.addColumn("management").setHeader("Management Mechanism").setAutoWidth(true).setResizable(true).setSortable(true);
			...
			longitudeColumn.setVisible(false);stateColumn.setVisible(false);
			districtColumn.setVisible(false);
			blockColumn.setVisible(false);
			villageColumn.setVisible(false);
			approvalColumn.setVisible(false);
