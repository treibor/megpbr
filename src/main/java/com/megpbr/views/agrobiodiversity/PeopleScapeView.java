...
@Route(value = "format-7", layout = MainLayout.class)
@Uses(Icon.class)
public class PeopleScapeView extends HorizontalLayout{
	...
	public PeopleScapeView(Dbservice service, ScapeService cservice, UserService uservice) {
	...
	public Component ConfigureGrid() {
		try {
			...
			localColumn=grid.addColumn(scape->scape.getFaunaPopulation()).setHeader("Community & Population").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("floraOccupation").setHeader("Families & Major Occupation").setAutoWidth(true).setResizable(true);
			grid.addColumn("typeAgriOccupation").setHeader("Sub Occupation").setAutoWidth(true).setResizable(true);
			grid.addColumn("landscape").setHeader("Depending Landscape").setAutoWidth(true).setResizable(true);
			grid.addColumn("fallow").setHeader("Major Resources & Season of Access").setAutoWidth(true).setResizable(true);
			//grid.addColumn("forest").setHeader("Forest").setAutoWidth(true).setResizable(true);
			//grid.addColumn("wetLand").setHeader("Wet Land").setAutoWidth(true).setResizable(true);
			//grid.addColumn("subLandscape").setHeader("Sub Landscapes").setAutoWidth(true).setResizable(true);
			grid.addColumn("features").setHeader("No. of HHs").setAutoWidth(true).setResizable(true);
			grid.addColumn("ownerHouse").setHeader("Caste/Tribe").setAutoWidth(true).setResizable(true);
			grid.addColumn("userGroups").setHeader("Nature of Inhabitants").setAutoWidth(true).setResizable(true);
			grid.addColumn("management").setHeader("Landscape Management Practices").setAutoWidth(true).setResizable(true);
			grid.addColumn("generalResources").setHeader("Resources Management Practices").setAutoWidth(true).setResizable(true);
			...
			grid.addColumn("socialCommunity").setHeader("Social Condition").setAutoWidth(true).setResizable(true);
