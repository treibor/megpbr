...
@PageTitle("Landscape")
@Route(value = "format-8", layout = MainLayout.class)
@Uses(Icon.class)
public class ScapeView extends HorizontalLayout{
	...
	public Component ConfigureGrid() {
		try {
			...
			localColumn=grid.addColumn(scape->scape.getFaunaPopulation()).setHeader("General Fauna").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("floraOccupation").setHeader("General Flora").setAutoWidth(true).setResizable(true);
			grid.addColumn("typeAgriOccupation").setHeader("Agricultural Land").setAutoWidth(true).setResizable(true);
			grid.addColumn("landscape").setHeader("Pond").setAutoWidth(true).setResizable(true);
			grid.addColumn("fallow").setHeader("Fallow Land").setAutoWidth(true).setResizable(true);
