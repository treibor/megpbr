...
@PageTitle("Weeds")
@Route(value = "format-4", layout = MainLayout.class)
@Uses(Icon.class)
public class WeedsView extends HorizontalLayout{
	...
	public WeedsView(Dbservice service, CropService cservice, UserService uservice) {
