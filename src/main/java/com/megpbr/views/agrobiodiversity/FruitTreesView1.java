...
@Route(value = "format-2x", layout = MainLayout.class)
@Uses(Icon.class)
public class FruitTreesView1 extends HorizontalLayout{
	...
	public FruitTreesView1(Dbservice service, CropService cservice, UserService uservice) {
