...
public class FodderCropsView extends HorizontalLayout{
	...
	public FodderCropsView(Dbservice service, CropService cservice, UserService uservice) {
	...
	public Component ConfigureGrid() {
		try {
			...
			//grid.addColumn("partUsed").setAutoWidth(true).setResizable(true).setSortable(true);
