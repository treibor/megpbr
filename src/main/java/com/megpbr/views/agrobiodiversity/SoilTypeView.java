...
@PageTitle("Soil Type")
@Route(value = "format-10", layout = MainLayout.class)
@Uses(Icon.class)
public class SoilTypeView extends HorizontalLayout{
	...
	public SoilTypeView(Dbservice service, ScapeService cservice, UserService uservice) {
	...
	private Component getToolbar() {
		filterText.setPlaceholder("Search by Soil Type/Texture/Features ");
	...
	public Component ConfigureGrid() {
		try {
			...
			localColumn=grid.addColumn(scape->scape.getFaunaPopulation()).setHeader("Soil Type").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("floraOccupation").setHeader("Colour & Texture").setAutoWidth(true).setResizable(true);
			grid.addColumn("typeAgriOccupation").setHeader("Features").setAutoWidth(true).setResizable(true);
			grid.addColumn("landscape").setHeader("Soil Management").setAutoWidth(true).setResizable(true);
			grid.addColumn("fallow").setHeader("Flora & Fauna").setAutoWidth(true).setResizable(true);
			grid.addColumn("forest").setHeader("Plant/Crop Suitable").setAutoWidth(true).setResizable(true);
