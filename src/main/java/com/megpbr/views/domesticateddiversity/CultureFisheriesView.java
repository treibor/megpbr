...
@PageTitle("Culture Fisheries")
@Route(value = "format-16", layout = MainLayout.class)
@Uses(Icon.class)
public class CultureFisheriesView extends HorizontalLayout {
	...
	public CultureFisheriesView(Dbservice service, CropService cservice, UserService uservice) {
	...
	public Component ConfigureGrid() {
		try {
			...
			grid.addColumn("type").setAutoWidth(true).setHeader("Fish Type").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("variety").setHeader("Variety").setAutoWidth(true).setResizable(true).setSortable(true);
