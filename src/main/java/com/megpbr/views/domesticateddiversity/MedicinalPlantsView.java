...
@Route(value = "format-12", layout = MainLayout.class)
@Uses(Icon.class)
public class MedicinalPlantsView extends HorizontalLayout {
	...
	public MedicinalPlantsView(Dbservice service, CropService cservice, UserService uservice) {
		this.dbservice = service;
		this.cservice = cservice;
		this.uservice = uservice;
		// this.auditservice=auditservice;
		format = dbservice.getFormat(12);
		setSizeFull();
		ConfigureGrid();
		ConfigureForm();
		ConfigureCombo();
	...
	public Component ConfigureGrid() {
		try {
			...
			//grid.addColumn("fruitSeason").setHeader("Season of Fruiting").setAutoWidth(true).setResizable(true).setSortable(true);
