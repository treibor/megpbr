...
@PageTitle("Ornamental Plants")
@Route(value = "format-13", layout = MainLayout.class)
@Uses(Icon.class)
public class OrnamentalPlantsView extends HorizontalLayout {
	...
	public OrnamentalPlantsView(Dbservice service, CropService cservice, UserService uservice) {
		this.dbservice = service;
		this.cservice = cservice;
		this.uservice = uservice;
		// this.auditservice=auditservice;
		format = dbservice.getFormat(13);
		setSizeFull();
		ConfigureGrid();
		ConfigureForm();
		ConfigureCombo();
