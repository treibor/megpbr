...
@Route(value = "format-11", layout = MainLayout.class)
@Uses(Icon.class)
public class DomFruitTreesView extends HorizontalLayout {
	...
	public DomFruitTreesView(Dbservice service, CropService cservice, UserService uservice) {
