...
@Route(value = "format-17", layout = MainLayout.class)
@Uses(Icon.class)
public class MarketsFairView extends HorizontalLayout{
	...
	public MarketsFairView(Dbservice service, MarketsService cservice, UserService uservice) {
	...
	private Component getToolbar() {
		filterText.setPlaceholder("Search by Market Name/ Types of Animal");
	...
	public Component ConfigureGrid() {
		try {
			...
			latitudeColumn=grid.addColumn("latitude").setAutoWidth(true).setResizable(true);;
			longitudeColumn=grid.addColumn("longitude").setAutoWidth(true).setResizable(true);;
