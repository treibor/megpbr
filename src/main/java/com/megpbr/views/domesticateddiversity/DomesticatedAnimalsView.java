package com.megpbr.views.domesticateddiversity;
...
@PageTitle("Domesticated Animals")
@Route(value = "format-15", layout = MainLayout.class)
@Uses(Icon.class)
public class DomesticatedAnimalsView extends HorizontalLayout {
	...
	public DomesticatedAnimalsView(Dbservice service, CropService cservice, UserService uservice) {
	...
	public Component ConfigureGrid() {
		try {
			...
			grid.addColumn("type").setAutoWidth(true).setHeader("Animal Type").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("variety").setHeader("Breed Type").setAutoWidth(true).setResizable(true).setSortable(true);
			...
			grid.addColumn("xfield2").setHeader("Method of Keeping").setAutoWidth(true).setResizable(true).setSortable(true);
