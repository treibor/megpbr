...
@PageTitle("Fumigate Chewing Plants")
@Route(value = "format-25", layout = MainLayout.class)
@Uses(Icon.class)
public class FumigateChewingView extends HorizontalLayout {
	...
	public FumigateChewingView(Dbservice service, CropService cservice, UserService uservice) {
		this.dbservice = service;
		this.cservice = cservice;
		this.uservice = uservice;
		// this.auditservice=auditservice;
		format = dbservice.getFormat(25);
		setSizeFull();
		ConfigureGrid();
		ConfigureForm();
		ConfigureCombo();
