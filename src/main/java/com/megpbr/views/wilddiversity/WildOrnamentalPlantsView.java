...
@PageTitle("Wild Ornamental Plants")
@Route(value = "format-24", layout = MainLayout.class)
@Uses(Icon.class)
public class WildOrnamentalPlantsView extends HorizontalLayout {
	...
	public WildOrnamentalPlantsView(Dbservice service, CropService cservice, UserService uservice) {
		this.dbservice = service;
		this.cservice = cservice;
		this.uservice = uservice;
		// this.auditservice=auditservice;
		format = dbservice.getFormat(24);
		setSizeFull();
		ConfigureGrid();
		ConfigureForm();
		ConfigureCombo();
