...
@PageTitle("Wild Plant Species of Importance")
@Route(value = "format-19", layout = MainLayout.class)
@Uses(Icon.class)
public class WildPlantSpeciesView extends HorizontalLayout {
	...
	public WildPlantSpeciesView(Dbservice service, CropService cservice, UserService uservice) {
		this.dbservice = service;
		this.cservice = cservice;
		this.uservice = uservice;
		// this.auditservice=auditservice;
		format = dbservice.getFormat(19);
		setSizeFull();
		ConfigureGrid();
		ConfigureForm();
		ConfigureCombo();
	...
	public Component ConfigureGrid() {
		try {
			...
			grid.addColumn("variety").setAutoWidth(true).setHeader("Variety").setAutoWidth(true).setResizable(true).setSortable(true);
			//grid.addColumn("partsUsed").setHeader("Parts Collected").setAutoWidth(true).setResizable(true).setSortable(true);
			...
			//grid.addColumn("management").setHeader("Commercial Rearing").setAutoWidth(true).setResizable(true).setSortable(true);
			//grid.addColumn("otherDetails").setAutoWidth(true).setResizable(true).setSortable(true);
			//grid.addColumn("specialFeatures").setHeader("Features").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("xfield1").setHeader("Importance: Economic/Social/Cultural").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("xfield2").setHeader("Status").setAutoWidth(true).setResizable(true).setSortable(true);
			...
			//grid.addColumn(crop-> crop.getCommercial()==null ? "":crop.getCommercial().getCname()).setHeader("Commercial?").setAutoWidth(true).setResizable(true).setSortable(true);
