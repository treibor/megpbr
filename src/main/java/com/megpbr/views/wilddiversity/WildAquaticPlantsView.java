...
@PageTitle("Wild Aquatic Plants")
@Route(value = "format-21", layout = MainLayout.class)
@Uses(Icon.class)
public class WildAquaticPlantsView extends HorizontalLayout{
	...
	public WildAquaticPlantsView(Dbservice service, CropService cservice, UserService uservice) {
		this.dbservice=service;
		this.cservice=cservice;
		this.uservice=uservice;
		//this.auditservice=auditservice;
		format=dbservice.getFormat(21);
		setSizeFull();
		ConfigureGrid();
		ConfigureForm();
		ConfigureCombo();
	...
	public Component ConfigureGrid() {
		try {
			...
			//grid.addColumn("partsUsed").setHeader("Parts Used").setAutoWidth(true).setResizable(true).setSortable(true);
			...
			grid.addColumn("xfield1").setHeader("Importance").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("xfield2").setHeader("Trends").setAutoWidth(true).setResizable(true).setSortable(true);
