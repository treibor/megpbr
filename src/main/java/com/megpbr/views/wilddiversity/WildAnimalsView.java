...
@PageTitle("Wild Animals")
@Route(value = "format-27", layout = MainLayout.class)
@Uses(Icon.class)
public class WildAnimalsView extends HorizontalLayout{
	...
	public WildAnimalsView(Dbservice service, CropService cservice, UserService uservice) {
		this.dbservice=service;
		this.cservice=cservice;
		this.uservice=uservice;
		//this.auditservice=auditservice;
		format=dbservice.getFormat(27);
		setSizeFull();
		ConfigureGrid();
		ConfigureForm();
		ConfigureCombo();
	...
	public Component ConfigureGrid() {
		try {
			...
			grid.addColumn("fruitSeason").setHeader("Season when seen").setAutoWidth(true).setResizable(true).setSortable(true);
			...
			grid.addColumn("xfield1").setHeader("Mode of Hunting").setAutoWidth(true).setResizable(true).setSortable(true);
