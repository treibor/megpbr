...
@PageTitle("Trees, Shrubs, Tubers, Grasses, Climbers etc")
@Route(value = "format-18", layout = MainLayout.class)
@Uses(Icon.class)
public class TreeShrubView extends HorizontalLayout {
	...
	public TreeShrubView(Dbservice service, CropService cservice, UserService uservice) {
		this.dbservice = service;
		this.cservice = cservice;
		this.uservice = uservice;
		// this.auditservice=auditservice;
		format = dbservice.getFormat(18);
		setSizeFull();
		ConfigureGrid();
		ConfigureForm();
		ConfigureCombo();
	...
	public Component ConfigureGrid() {
		try {
			...
			//grid.addColumn("xfield2").setHeader("Commercial/Own Use").setAutoWidth(true).setResizable(true).setSortable(true);
