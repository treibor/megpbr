...
@PageTitle("Wild Relatives")
@Route(value = "format-23", layout = MainLayout.class)
@Uses(Icon.class)
public class WildRelativesView extends HorizontalLayout{
	...
	public WildRelativesView(Dbservice service, CropService cservice, UserService uservice) {
	...
	public Component ConfigureGrid() {
		try {
			...
			grid.addColumn("uses").setHeader("Usage").setAutoWidth(true).setResizable(true).setSortable(true);
			grid.addColumn("otherDetails").setHeader("Other Details (Mode of Use)").setAutoWidth(true).setResizable(true).setSortable(true);
