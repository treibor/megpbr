...
@PageTitle("Wild Plants of Medicinal Importance")
@Route(value = "format-22", layout = MainLayout.class)
@Uses(Icon.class)
public class WildPlantsMedicinalView extends HorizontalLayout {
	...
	public WildPlantsMedicinalView(Dbservice service, CropService cservice, UserService uservice) {
