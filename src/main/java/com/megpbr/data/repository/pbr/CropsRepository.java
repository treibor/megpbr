...
public interface CropsRepository extends JpaRepository<Crops, Long> {
	...
	List<Crops> search(@Param("state") State state, @Param("searchTerm") String searchTerm,
	...
	// Crops Count By Year
	@Query("select  count(*) from Crops c join c.village d join d.block e join e.district f where c.master =:master and   district=:district and c.enteredOn between :sdate and :edate")
	int getCropsCountYear(@Param("district") District district, @Param("master") boolean master,
			@Param("sdate") LocalDateTime sdate, @Param("edate") LocalDateTime edate);

	// Crops Count By Year
	@Query("select  count(*) from Crops c join c.village d join d.block e join e.district f where c.master =:master and c.enteredOn between :sdate and :edate")
	int getCropsCountYearly(@Param("master") boolean master,@Param("sdate") LocalDateTime sdate, @Param("edate") LocalDateTime edate);
	...
	List<Crops> searchFilterCropsData(@Param("district") District district, @Param("searchTerm") String searchTerm,
			@Param("format") MasterFormat format);
	...
	List<Crops> searchFilterCropsData(@Param("block") Block block, @Param("searchTerm") String searchTerm,
			@Param("format") MasterFormat format);
	...
	List<Crops> searchFilterCropsData(@Param("village") Village village, @Param("searchTerm") String searchTerm,
			@Param("format") MasterFormat format);
	...
	List<Crops> searchFilterByMaster(@Param("village") Village village, @Param("searchTerm") String searchTerm,
